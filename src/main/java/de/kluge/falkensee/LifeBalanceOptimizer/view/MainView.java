...
public class MainView extends VerticalLayout {
    ...
    private LikeRepository employeeRepository;
	
    private LikeViewVn editor;
    
    final Grid<UserEntity> grid;
    
    final  TextField filter;
    
    private final Button addNewBtn;
	
    public MainView(LikeRepository repo, LikeViewVn editor) {
    	employeeRepository = repo;
    	this.editor = editor;
    	this.grid = new Grid<>(UserEntity.class);
